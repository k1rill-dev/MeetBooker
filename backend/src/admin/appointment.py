...
class AppointmentAdmin(ModelView, model=Appointment):
    column_list = [Appointment.id, Appointment.user, Appointment.specialist, Appointment.slot,
    ...
    form_columns = [Appointment.id, Appointment.user, Appointment.specialist, Appointment.slot,
                   Appointment.is_confirmed]