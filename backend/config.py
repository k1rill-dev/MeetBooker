...
class Settings(BaseSettings):
    ...
    private_key: str = BASE_DIR.joinpath('src/certs/jwt-private.pem').read_text()
    public_key: str = BASE_DIR.joinpath('src/certs/jwt-public.pem').read_text()
    ...
    path_to_media: pathlib.Path = BASE_DIR.joinpath('media/')
